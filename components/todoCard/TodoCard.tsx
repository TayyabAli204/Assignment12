            ...
            <Card style={{ backgroundColor: '#CDECF8' }}>
                <CardBody>
                    ...
                    <InputGroup size='md' style={{ backgroundColor: 'white' }}>
                        ...
                        />
                        <InputRightElement >
    <Button onClick={onClickHandler} style={{ backgroundColor: '#1c72db', borderRadius: 0, color: 'white' }} h='2.4rem' size='sm' onClick={() => null}>
     ...
     <AddIcon onClick={onClickHandler} w={6} h={3} />}
                    ...
                    <Stack mt='4' spacing='3'>
                        {todos.map((item: TodoType) => {
                            return (
                                <>
                                    <Text mt="2" py='1' style={{ backgroundColor: 'white' }}>{item.description}</Text>
